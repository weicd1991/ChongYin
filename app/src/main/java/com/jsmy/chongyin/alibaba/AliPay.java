package com.jsmy.chongyin.alibaba;
...
import com.jsmy.chongyin.activity.PayVIPActivity;
...
public class AliPay {
    ...
    private PayVIPActivity context;

    public AliPay(PayVIPActivity activity) {
...
//                            Toast.makeText(context, "支付结果确认中", Toast.LENGTH_SHORT).show();
                            ToastUtil.showShort(context,"支付结果确认中...");
