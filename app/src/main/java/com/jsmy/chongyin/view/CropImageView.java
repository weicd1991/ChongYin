...
public class CropImageView extends View {
    ...
    public void setDrawable(Drawable mDrawable, int cropWidth, int cropHeight) {
        ...
        this.imgWidth = dm.widthPixels;
        this.imgHeight = dm.heightPixels - UtilsTools.dip2px(getContext(), 80);
        MyLog.showLog("III", "imgWidth= " + imgWidth + ",imgHeight= " + imgHeight);
        this.isFrist = true;
        invalidate();
    }
...
//        // 取 drawable 的颜色格式
//        Bitmap.Config config = mDrawable.getOpacity() != PixelFormat.OPAQUE ? Bitmap.Config.ARGB_8888
//                : Bitmap.Config.RGB_565;
//        // 建立对应 bitmap
//        Bitmap bitmap = Bitmap.createBitmap(imgWidth, imgHeight, config);
//        RectF rectF = new RectF(0, 0, imgWidth, imgWidth);
//
