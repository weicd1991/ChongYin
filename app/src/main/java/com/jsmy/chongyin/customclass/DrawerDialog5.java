...
public class DrawerDialog5 extends Dialog implements View.OnClickListener, View.OnLayoutChangeListener {
    ...
    public DrawerDialog5(MainActivity context, int themeResId, int num) {
        super(context, themeResId);
        this.position = num;
        this.context = context;
        this.view = LayoutInflater.from(context).inflate(R.layout.pop_drawer5, null);
        initView(this.view);
        initDanmu(this.view);
        initFood(this.view);
        initEmoji(this.view);
    ...
    public void onEventMainThread(DowloadEvent event) {
        MyLog.showLog("drawer"," - " + event.getCode());
