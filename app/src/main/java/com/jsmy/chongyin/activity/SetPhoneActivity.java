...
public class SetPhoneActivity extends BaseActivity {
    ...
    protected void initView() {
        if (MyApplication.msgTime3 > 0) {
            getMsg(false);
            tvMsg.setText(MyApplication.msgTime3 + "秒后再次获取");
        ...
        if ("Y".equals(code)) {
            switch (DecodeData.getCodeRoMsg(result, DecodeData.CHECK)) {
                ...
                case ServiceCode.UP_DATE_ZH_BD_NUM:
                    EventBus.getDefault().post(new DowloadEvent("updatephone","updatephone"));
                    finish();
                    break;
                default:
                    break;
            ...
            tvMsg.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (checkDh()) {
                        ...
                        ToastUtil.showShort(SetPhoneActivity.this, "请输入11位手机号");
